...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { description: @menu_item.description, price: @menu_item.price, title: @menu_item.title }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { description: @menu_item.description, price: @menu_item.price, title: @menu_item.title }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
