class nerd_monkey::install_ruby {

  # nerd_monkey::install_nginx depends on this ruby/version combination
  $ruby_type = "ruby"
  $ruby_version = "2.1.2"
  ...
  file { '/etc/profile.d/chruby.sh':
    ...
    source => '/vagrant/puppet/modules/nerd_monkey/files/chruby.sh',
